...
class CreateCourseMaterialManagementsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Course_material_managements", 'course_material_managements', 'coursename', 'fa-cube', [
            ["coursename", "Course Name", "Dropdown", false, "", 0, 0, true, "@course_details"],
            ["coursematerial", "Course Material", "Files", false, "", 0, 0, true],
            ["status", "Status", "Dropdown", false, "", 0, 0, true, ["Active","In-Aactive"]],
        ]);
