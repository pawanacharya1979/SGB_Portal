...
class CreateCourseProgramsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Course_programs", 'course_programs', 'course_program', 'fa-cube', [
            ["course_program", "Course Program", "File", false, "http://dai.avedemos.uk/public/course-materials", 0, 0, false],
        ]);
    ...
    {
        if (Schema::hasTable('course_programs')) {
