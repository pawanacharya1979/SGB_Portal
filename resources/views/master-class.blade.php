...
<div class="slider-inner">
          ...
          <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
            <h1>{{$Data->bannerheader1}}</h1>
             <p>{{$Data->bannerheader2}}</p>
             </div>
      ...
      <div class="container">
        <div class="mrg-30 local-content">
          ...
          <!-- @if($Data->contentblock3 != '')  
              {!!$Data->contentblock3!!}
          @endif-->

          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 download-btn">
          <h4>Download <span class="dwn-smb"><i class="fa fa-angle-double-down" aria-hidden="true"></i>
          </span></h4>
             <div class="colr-blue"><a href="<?php if(!empty($Data->coursebrochure)){echo $Data->coursebrochure;}else{echo '';} ?>" target="_blank">Course Brochure</a></div>
             <div class="colr-drk-blu"><a href="<?php if(!empty($Data->exampleprogram)){echo $Data->exampleprogram;}else{echo '';} ?>" target="_blank">Example Program</a></div>
             <div class="colr-brown"><a href="<?php if(!empty($Data->registration)){echo $Data->registration;}else{echo '';} ?>" target="_blank">Registration</a></div>
          </div>
          </div>
        </div>
