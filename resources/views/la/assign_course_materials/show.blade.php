...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $assign_course_material->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Assign_Course_Materials", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/assign_course_materials/'.$assign_course_material->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Assign_Course_Materials", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.assign_course_materials.destroy', $assign_course_material->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/assign_course_materials') }}" data-toggle="tooltip" data-placement="right" title="Back to Assign Course Materials"><i class="fa fa-chevron-left"></i></a></li>
