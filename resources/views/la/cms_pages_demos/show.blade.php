...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $cms_pages_demo->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("CMS_Pages_Demos", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/cms_pages_demos/'.$cms_pages_demo->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("CMS_Pages_Demos", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.cms_pages_demos.destroy', $cms_pages_demo->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/cms_pages_demos') }}" data-toggle="tooltip" data-placement="right" title="Back to CMS Pages Demos"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'short description')
						@la_display($module, 'name')
						@la_display($module, 'content')
						@la_display($module, 'added on')
						@la_display($module, 'updated on')
