...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $cms_page->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("CMS_Pages", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/cms_pages/'.$cms_page->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("CMS_Pages", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.cms_pages.destroy', $cms_page->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/cms_pages') }}" data-toggle="tooltip" data-placement="right" title="Back to CMS Pages"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'pagetitle')
						@la_display($module, 'pagesubtitle')
						@la_display($module, 'bannerheader1')
						@la_display($module, 'bannerheader2')
						@la_display($module, 'bannerbackground1')
						@la_display($module, 'bannerbackground2')
						@la_display($module, 'contentblock1')
						@la_display($module, 'contentblock2')
						@la_display($module, 'contentblock3')
						@la_display($module, 'coursebrochure')
						@la_display($module, 'exampleprogram')
