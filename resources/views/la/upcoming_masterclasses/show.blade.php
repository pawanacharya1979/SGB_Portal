...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $upcoming_masterclass->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Upcoming_Masterclasses", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/upcoming_masterclasses/'.$upcoming_masterclass->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Upcoming_Masterclasses", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.upcoming_masterclasses.destroy', $upcoming_masterclass->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/upcoming_masterclasses') }}" data-toggle="tooltip" data-placement="right" title="Back to Upcoming Masterclasses"><i class="fa fa-chevron-left"></i></a></li>
