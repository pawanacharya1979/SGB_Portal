...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $upcoming_master_class->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Upcoming_Master_Classes", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/upcoming_master_classes/'.$upcoming_master_class->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Upcoming_Master_Classes", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.upcoming_master_classes.destroy', $upcoming_master_class->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/upcoming_master_classes') }}" data-toggle="tooltip" data-placement="right" title="Back to Upcoming Master Classes"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'coursename')
						@la_display($module, 'coursedetails')
						@la_display($module, 'applicationform')
