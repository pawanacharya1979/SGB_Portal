...
<div class="box box-success">
	...
	<div class="box-body">
		<table id="example1" class="table table-bordered table-users">
		<thead>
		<tr class="success">
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				{!! Form::submit( 'Submit', ['class'=>'btn btn-success', 'id'=> 'btnSubmitSave']) !!}
			</div>
...
<script>
      ...
      $('#btnSubmit').on('click', function(e){
		...
		$(document).ready(function() {
			...
			$(".table-users button.btn-danger").click(function(e){
				var r = confirm("Do you wish to continue?");
				if (r == true) {
