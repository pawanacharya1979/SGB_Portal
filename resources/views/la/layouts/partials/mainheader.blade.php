...
<header class="main-header">
	...
	<a href="{{ url(config('laraadmin.adminRoute')) }}" class="logo">
		<!-- mini logo for sidebar mini 50x50 pixels -->
                <span class="logo-mini"><img src="{{asset('/la-assets/img/laraadmin_logo.png')}}" alt="user image" class="online"></span>
		<!-- logo for regular state and mobile devices -->
		<span class="logo-lg"><img src="{{asset('/la-assets/img/laraadmin_logo.png')}}" alt="user image" class="online"></span>
	</a>
	@endif
