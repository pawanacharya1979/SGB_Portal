...
var Editor = /** @class */ (function () {
    function Editor(context) {
        ...
        this.createLink = this.wrapCommand(function (linkInfo) {
            ...
            var addClass = linkInfo.addClass;
            ...
            if (isTextChanged) {
                rng = rng.deleteContents();
                var anchor = rng.insertNode($$1('<A class="'+addclass+'">' + linkText + '</A>')[0]);
                anchors.push(anchor);
            }
            else {
...
var LinkDialog = /** @class */ (function () {
    ...
    LinkDialog.prototype.initialize = function () {
        ...
        var body = [
            ...
            '</div>',
            '<div class="form-group note-form-group">',
            "<label class=\"note-form-label\">" + this.lang.link.addClass + "</label>",
            '<input class="note-link-class form-control note-form-control note-input" type="text" value="" />',
            '</div>',
    ...
    LinkDialog.prototype.showLinkDialog = function (linkInfo) {
        ...
        return $$1.Deferred(function (deferred) {
            ...
            var $addClass = _this.$dialog.find('.note-link-class');
